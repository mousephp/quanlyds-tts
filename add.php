...
<body>
	...
	if(isset($_POST["btnsubmit"])) {
		...
		if(empty($_FILES['fileToUpload']['name'])){
			$err= "<p style='color:red;'>bạn cần nhập file ảnh!</p>";
		}
...
// Nếu mọi thứ đều ổn, hãy thử tải lên tập tin
		...
		if (mysqli_num_rows($thucthi)>0) {
			...
			$sql_insert="INSERT INTO thuctapsinh (avatar,ten,ngaysinh,gioitinh,email,diachi,ngayvao,thoigiancomat,camket,cmnn,phuongtien,bienso,reviewlan1,reviewlan2,danhgia) VALUES ('$target_file','$ten','$ngaysinh','$gioitinh','$email','$diachi','$ngayvao','$thoigiancomat','$camket','$cmnn','$phuongtien','$bienso','$reviewlan1','$reviewlan2','$danhgia')";	
...
<div class="container">
	<div class="row text-center">
		<div class="col-sm-11 col-sm-offset-1">
			<h3 style="text-align: center;color: green;">THÊM THỰC TẬP SINH</h3>
			<?php echo $err; ?>
			<form  class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="col-sm-6 ">
						<input  type="text" class="form-control" placeholder="nhập họ và tên" name="ten">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6 ">
						<input type="date" class="form-control" placeholder="Ngày vào thực tập" name="ngayvao">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6 ">
						<textarea class="form-control" type="text" rows="5" name="thoigiancomat"></textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6 ">
						<input type="radio" checked name="camket" value="dongy">Đồng ý
						<input type="radio" name="camket" value="khongdongy">Không đồng ý
						<br>						
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6 ">
						<input type="text" class="form-control" placeholder="CMNN" name="cmnn">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6 ">
						<input type="text" class="form-control" placeholder="phương tiện di chuyển" name="phuongtien">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6 ">
						<input type="text" class="form-control" placeholder="biển số xe" name="bienso">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3 ">
						<input type="date" class="form-control" placeholder="lan1" name="reviewlan1">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3 ">
						<input type="date" class="form-control" placeholder="lan2" name="reviewlan2">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6 ">
						<textarea class="form-control" type="text" rows="5" name="danhgia"></textarea>
					</div>
				</div> 

				<input class="form-control btn-success" type="submit" name="btnsubmit" value="Thêm" ></input>
