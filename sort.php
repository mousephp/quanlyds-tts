...
<body>
	...
	<?php }else if(isset($_GET['theotuoi'])){ ?>
		<div class="">
			<h2 style="text-align: center;color: blue;">DANH SÁCH THỰC TẬP SINH</h2>
			...
			<table class="table" style="width: 1800px;">
				...
				<tbody>					
					<?php 				
					$row_sql="SELECT * FROM thuctapsinh ORDER BY ngaysinh DESC";
					$row_thuchien=mysqli_query($conn,$row_sql);
					while($dulieu =mysqli_fetch_array($row_thuchien)){
						?>			
						<tr class="">
	...
	<?php }else{ ?>
		<div class="">
			...
			<table class="table" style="width: 1800px;">
				...
				<tbody>					
					<?php 				
					$row_sql="SELECT * FROM thuctapsinh ORDER BY ngayvao DESC";
					$row_thuchien=mysqli_query($conn,$row_sql);
					while($dulieu =mysqli_fetch_array($row_thuchien)){
						?>			
						<tr class="">
